...
export default function LikeAndDislike() {
  ...
  const [iconLikeColor, setIconLikeColor] = useState("white");
  const [iconDisLikeColor, setIconDisLikeColor] = useState("white");
      ...
      <div>
        ...
        <div className=" d-flex gap-1 mt-3">
          <button
            ...
            style={{ backgroundColor: likeColor, color: iconLikeColor }}
          >
            <svg
